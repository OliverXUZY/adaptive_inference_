...
def create_model(
    ...
    # print(f"zhuoyan: create_fn: {create_fn} | model_name: {model_name}")
    with set_layer_config(scriptable=scriptable, exportable=exportable, no_jit=no_jit):
        # print(f"zhuoyan: pretrained: {pretrained}")
        # print(f"zhuoyan: pretrained_cfg: {pretrained_cfg}")
        # print(f"zhuoyan: pretrained_cfg_overlay: {pretrained_cfg_overlay}")
        # print(f"zhuoyan: kwargs: {type(kwargs)}{kwargs.keys()}")
